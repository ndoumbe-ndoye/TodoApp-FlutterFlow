...
class _LoginWidgetState extends State<LoginWidget>
  ...
  void initState() {
    ...
    _model.signuPasswordTextController ??= TextEditingController();
    _model.signuPasswordFocusNode ??= FocusNode();
              ...
              child: Column(
                ...
                children: [
                  ClipRRect(
                    ...
                    child: Image.asset(
                      'assets/images/IMG_2DAA350CC554-1.jpeg',
                      width: 120.0,
                      fit: BoxFit.cover,
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: TextFormField(
                                          controller: _model
                                              .signuPasswordTextController,
                                          focusNode:
                                              _model.signuPasswordFocusNode,
                                          autofocus: false,
                                          textInputAction: TextInputAction.next,
                                          obscureText:
                                              !_model.signuPasswordVisibility,
                                          decoration: InputDecoration(
                                            isDense: true,
                                            labelStyle:
                                                FlutterFlowTheme.of(context)
                                          ...
                                          cursorColor:
                                              FlutterFlowTheme.of(context)
                                                  .primaryText,
                                          validator: _model
                                              .signuPasswordTextControllerValidator
                                              .asValidator(context),
                                        ),
                                      ),
                                    ),
                      ...
                      if (_model.tabBarCurrentIndex == 1)
                        FFButtonWidget(
                          onPressed: () async {
                            ...
                            context.goNamedAuth(
                                TaskWidget.routeName, context.mounted);
                          },
                          text: 'Login',
                      ...
                      if (_model.tabBarCurrentIndex == 0)
                        FFButtonWidget(
                          onPressed: () async {
                            ...
                            GoRouter.of(context).prepareAuthEvent();
                            if (_model.signuPasswordTextController.text !=
                            ...
                            final user =
                              ...
                              _model.signuPasswordTextController.text,
                            );
                            if (user == null) {
                              return;
                            }
